...
class OrdinalTreeTests(unittest.TestCase):
    def test_threshold_probs_to_class_probs_produces_six_classes(self):
    ...
    def test_expected_value_from_class_probs_uses_score_ids(self):
    ...
    def test_expected_values_from_week_class_probs_vectorized(self):
